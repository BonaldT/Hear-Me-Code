...
movie_titles = ["Gone With the Wind", "The Graduate", "E.T.", "Dog Day Afternoon", "Frozen"]
parental_rating = ["G", "PG", "PG", "R", "PG"]
bechdel_rating = ["3", "2", "3", "3", "3"]
imdb_rating = ["8.2", "8.0", "7.9", "8.0", "7.5"]
genre = ["Drama / History / Romance", "Comedy / Drama / Romance", "Family / Sci-Fi", "Biography / Crime / Drama", "Animation / Adventure / Comedy"]

print "Title, Rating, Bechdel, IMDB, Genre"

for (movie, rating, Bechdel, IMDB, genre) in zip(movie_titles, parental_rating, bechdel_rating, imdb_rating, genre):
    print "{0}, {1}, {2}, {3}, {4}".format(movie, rating, Bechdel, IMDB, genre)
