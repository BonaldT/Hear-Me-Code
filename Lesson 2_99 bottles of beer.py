...
If one of those bottles should happen to fall, {2} bottles of beer on the wall""".format(beer, beer, beer-1)
        beer = beer - 1
...
If that bottle should happen to fall, no more bottles of beer on the wall"""
